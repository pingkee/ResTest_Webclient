  ...
  return (
    <div style={{ margin: 25, maxWidth: "60%" }}>
        ...
        <p style={{ textAlign: "justify" }}>
            ...
            and disclosure of user submitted Information if anyone decided to use my Service.
            If you choose to use my Service, then you agree to the collection and use of information or user submitted data in relation to this policy.
            The user submited data that I collect is used for providing and improving the Service.
            I will not use or share your personal information with anyone except as described in this Privacy Policy.
            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
            which is accessible at restest webpage unless otherwise defined in this Privacy Policy.
        </p>
        ...
        <p style={{ textAlign: "justify" }}>
            ...
            his Log Data may include information such as your device Internet Protocol (“IP”) address, device name, operating system version, 
        ...
        <h3>Contact Us</h3>
        <p style={{ textAlign: "justify" }}>
            If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at Here and now.
            This privacy policy page was created by Ping Kee
        </p>
    </div>
  )
};
